       ...
       <div class="col-sm-2 col-xs-6" ng-repeat="members in members">
                        <div class="active_mem_item">
                            <ul class="nav navbar-nav">
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="uploads/profile/{{members.profile_pic}}" alt=""></a>
