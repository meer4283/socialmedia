...
.banner_area.profile_banner {
  ...
  height: 80px
                        ...
                        <div class="right_side_content">
                            ...
                            <button ng-click="SendMessage('<?php if(isset($my_user_id)){echo $my_user_id;} ?>','<?php if(isset($user_id)){echo $user_id;} ?>', '<?php if(isset($my_user_id)){echo 'yes';}else{ echo 'no'; } ?>')"  class="btn form-control login_btn">Chat Now <img src="img/comment.png" alt=""></button>
                        </div>
                    </div>
                </div>
            </div>
