<?php
	...
	if (mysqli_query($link, $sendmessage)) {
		$sendmessage1 = "INSERT INTO `messages` (`id`, `from_user_id`, `to_user_id`, `message_content`, `message_type`, `message_time`, `message_status`) VALUES (NULL, '$to_user_id', '$from_user_id', '$content', '$type', '$time', 'Read')";
		if (mysqli_query($link, $sendmessage1)) {
			echo "send";
		}
	} else {
		echo "error";
