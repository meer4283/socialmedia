...
<!-- Mirrored from html.verodate.com/verodate/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 17:34:31 GMT -->
<head>
        <meta charset="utf-8">
            ...
            <div class="advanced_search">
                <div class="container">
                    ...
                    <form action="members.php" method="GET">
                        ...
                        <div class="search_item">
                            <h5>Seeking a</h5>
                            <select class="selectpicker" name="looking_for">
                                <option value="female">Woman</option>
                                <option value="male">Man</option>
                            </select>
                        </div>
                        <div class="search_item">
                            <h5>From</h5>
                            <select class="selectpicker" name="age_from">
                        ...
                        <div class="search_item">
                            <h5>To</h5>
                            <select class="selectpicker" name="age_to">
                            <option value="18">18</option>
                                <option value="19">19</option>
                                <option value="20">20</option>
                                <option value="21">21</option>
                        ...
                        <div class="search_item">
                            <button type="submit" value="submit" class="btn form-control login_btn" name="submit">Search</button>
                        </div>
                        </form>
                    </div>
                </div>
        ...
        <section class="welcome_area">
            <div class="container">
                <div class="welcome_title">
                    <h3>Welcome to <span>Dating</span>Site</h3>
...
<!-- Mirrored from html.verodate.com/verodate/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Apr 2021 17:35:24 GMT -->
</html>